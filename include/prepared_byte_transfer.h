...
public:
    ...
    void mark_producer_done() { producer_done_ = true; }
    ...
    uint32_t consumer_activity_ms() const { return consumer_activity_ms_; }
    bool consumer_attached() const { return consumer_attached_; }
    bool consumer_closed() const { return consumer_closed_; }
...
private:
    ...
    uint32_t consumer_activity_ms_ = 0;
    bool consumer_attached_ = false;
