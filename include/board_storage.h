...
static constexpr uint32_t AC_FILE_LOG_ACTIVE_DRAIN_INTERVAL_MS = 10000;
static constexpr size_t AC_FILE_LOG_ACTIVE_DRAIN_BUDGET = 1;
static constexpr size_t AC_FILE_LOG_ACTIVE_WRITE_BUDGET_ITEMS = 1;
static constexpr size_t AC_FILE_LOG_ACTIVE_WRITE_BUDGET_BYTES = 512;
