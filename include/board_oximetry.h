...
static constexpr uint16_t AC_OXIMETRY_SENSOR_AUTO_SCAN_INTERVAL_MS = 200;
static constexpr uint16_t AC_OXIMETRY_SENSOR_AUTO_SCAN_WINDOW_MS = 20;
static constexpr uint32_t AC_OXIMETRY_SENSOR_SCAN_IDLE_MIN_MS = 15000;
static constexpr uint32_t AC_OXIMETRY_SENSOR_SCAN_IDLE_MAX_MS = 60000;
